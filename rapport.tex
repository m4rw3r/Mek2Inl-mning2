...
\label{IoejIz}
	...
	radien vid ekvatorn: $R_e=6378,1370 \,\mathrm{km}$. För att få jordens tröghetsmoment slår vi
	...
	dagar i motsatt riktning till dygn-snurr. Precessionshastigheten blir då $\frac{-598\pi}{298 \cdot 86400 \,\mathrm{s}} = 7,2966 \cdot 10^{-5}$, eller $1,0034$ varv per dygn.
	...
	\subsection{Delproblem c}
		...
		Kan även resonera kring att de 3 alltid ligger i ett plan som är fixt i 
