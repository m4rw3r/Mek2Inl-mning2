...
\title{Stelkroppsrörelse i rummet}
	...
	\begin{abstract}
	  Stelkroppsrörelse i rummet betraktas. Vi reflekterar över behovet av att inför kroppsfixta koordinater och använder sådana för att ta fram ett speciallfall av Euler ekvationer. Dessa ekvationer används sedan för att betrakta två situation där betrakta kropparna inte har något externt vridande moment. Vi betraktar först speciallfallet då $I_{xx}=I_{yy}$ och härleder en relation mellan precession och spinn längsmed huvudsymmetriaxeln. Denna relation används sedan för att ta fram jordens precession, som visar sig vara $1,0034$ varv per dygn
	\end{abstract}
