...
\label{IoejIz}
	...
	precessionsvektor vid jordytan, $b=10 \,\mathrm{m}$. Radien vid polerna är $R_p= 6356,7523 \,\mathrm{km}$ \footnote[1]{Källa: http://en.wikipedia.org/wiki/Earth\_radius\#Fixed\_radii},
	radien vid ekvatorn: $R_e=6378,1370 \,\mathrm{km}$ \footnote[1]{Källa: http://en.wikipedia.org/wiki/Earth\_radius\#Fixed\_radii}. För att få jordens tröghetsmoment integrerar över en homogen ellipsoid.
