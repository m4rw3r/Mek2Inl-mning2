...
\section{Problem 3}
	...
	\end{center}
		...
		vinkelhastigheter i $x$- och $z$-led, med större rotation i $y$-led, då kommer $\dot{\omega_y}$ inte bli negativt
		nog och rotationsrörelsen ändrar sig markant. Problemet blir instabilt: små
		störrningar i $x$ och $z$-led ger stora skillnader. Detta överänsstämmer väl med
		det vi observerade i vårt experiment.
